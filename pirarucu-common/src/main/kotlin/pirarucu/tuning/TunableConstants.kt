...
object TunableConstants {
    ...
    val QS_FUTILITY_VALUE = intArrayOf(0,
        max(MATERIAL_SCORE_MG[1], MATERIAL_SCORE_EG[1]) + 100,
        max(MATERIAL_SCORE_MG[2], MATERIAL_SCORE_EG[2]) + 100,
        max(MATERIAL_SCORE_MG[3], MATERIAL_SCORE_EG[3]) + 100,
        max(MATERIAL_SCORE_MG[4], MATERIAL_SCORE_EG[4]) + 100,
        max(MATERIAL_SCORE_MG[5], MATERIAL_SCORE_EG[5]) + 100)
    ...
    val OTHER_BONUS_MG = intArrayOf(24, 0, 29, 6)
    val OTHER_BONUS_EG = intArrayOf(58, 7, 0, 6)
