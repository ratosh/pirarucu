...
class UciInputTest {
    ...
    fun testGoInfinite() {
        ...
        uciInput.process("ucinewgame")
        uciInput.process("isready")
        uciInput.process("position startpos")
        uciInput.process("isready")
        uciInput.process("go infinite")
        uciInput.process("isready")
    }
}
