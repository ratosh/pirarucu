...
class BitboardMoveTest {
    ...
    fun testKnightMoves() {
        ...
        assertEquals(
            BitboardMove.KNIGHT_MOVES[Square.E5], Bitboard.C4 or Bitboard.D3 or
    ...
    fun testBishopMoves() {
        assertEquals(
            BitboardMove.bishopMoves(Square.A1, 0L), Bitboard.B2 or Bitboard.C3 or
                Bitboard.D4 or Bitboard.E5 or Bitboard.F6 or Bitboard.G7 or Bitboard.H8
        )
        assertEquals(
            BitboardMove.bishopMoves(Square.E5, 0L),
        ...
        assertEquals(
            BitboardMove.bishopMoves(Square.H8, 0L), Bitboard.A1 or
    ...
    fun testRookMoves() {
        assertEquals(
            BitboardMove.rookMoves(Square.A1, 0L), Bitboard.B1 or Bitboard.C1 or
        ...
        assertEquals(
            BitboardMove.rookMoves(Square.E5, 0L), Bitboard.A5 or Bitboard.B5 or
        ...
        assertEquals(
            BitboardMove.rookMoves(Square.H8, 0L), Bitboard.A8 or Bitboard.B8 or
    ...
    @Test
    fun testQueenMoves() {
        assertEquals(PlatformSpecific.bitCount(BitboardMove.queenMoves(Square.A1, 0L)), 21)
        assertEquals(PlatformSpecific.bitCount(BitboardMove.queenMoves(Square.E5, 0L)), 27)
        assertEquals(PlatformSpecific.bitCount(BitboardMove.queenMoves(Square.H8, 0L)), 21)
    }
    ...
    fun testKingMoves() {
        ...
        assertEquals(
            BitboardMove.KING_MOVES[Square.E5],
    ...
    fun testPinnedMask() {
        assertEquals(
            BitboardMove.PINNED_MOVE_MASK[Square.A1][Square.H8], Bitboard.B2 or
                Bitboard.C3 or Bitboard.D4 or Bitboard.E5 or Bitboard.F6 or Bitboard.G7 or Bitboard.H8
        )
        assertEquals(
            BitboardMove.PINNED_MOVE_MASK[Square.A1][Square.H8] xor Bitboard.H8,
            BitboardMove.PINNED_MOVE_MASK[Square.H8][Square.A1] xor Bitboard.A1
        )
        assertEquals(
            BitboardMove.PINNED_MOVE_MASK[Square.A1][Square.A8], Bitboard.A2 or
                Bitboard.A3 or Bitboard.A4 or Bitboard.A5 or Bitboard.A6 or Bitboard.A7 or Bitboard.A8
        )
        assertEquals(
            BitboardMove.PINNED_MOVE_MASK[Square.A1][Square.A8] xor Bitboard.A8,
        ...
        assertEquals(
            BitboardMove.PINNED_MOVE_MASK[Square.A1][Square.H1], Bitboard.B1 or
                Bitboard.C1 or Bitboard.D1 or Bitboard.E1 or Bitboard.F1 or Bitboard.G1 or Bitboard.H1
        )
        assertEquals(
            BitboardMove.PINNED_MOVE_MASK[Square.A1][Square.H1] xor Bitboard.H1,
