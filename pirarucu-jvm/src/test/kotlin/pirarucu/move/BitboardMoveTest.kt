...
class BitboardMoveTest {
    ...
    fun testPawnAttack() {
        ...
        assertEquals(BitboardMove.PAWN_ATTACKS[Color.WHITE][Square.A2],
            BitboardMove.pawnAttacks(Color.WHITE, Bitboard.A2))
        assertEquals(BitboardMove.PAWN_ATTACKS[Color.WHITE][Square.H2], Bitboard.G3)
        assertEquals(BitboardMove.PAWN_ATTACKS[Color.WHITE][Square.H2],
        ...
        assertEquals(BitboardMove.PAWN_ATTACKS[Color.BLACK][Square.B3],
