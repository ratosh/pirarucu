...
//
            tuningObject.registerTuningData(
                    TexelTuningData(
                            ...
                            intArrayOf(0, 0, 9, 9, 10, 11),
                            true, intArrayOf(0, 1), 16, 1
                    )
            )
            ...
            tuningObject.registerTuningData(
                    TexelTuningData(
                            ...
                            true, intArrayOf(0, 1, 2, 3, 28, 29, 30, 31), 16, 1
                    )
            )
            ...
            tuningObject.registerTuningData(
                    TexelTuningData(
                            ...
                            true, intArrayOf(0, 1, 4, 5, 6), 16, 1
                    )
            )
    ...
    fun main(args: Array<String>) {
        ...
        val epdList = loadEpdFiles(listOf("g:\\chess\\epds\\texel-sets\\lichess_quiet.epd"))
...
//        searchOptimize(tuningObjects, epdList)
    ...
    private fun moveScoreOptimize(tuningController: TexelTuningController, epdList: List<EpdInfo>) {
        val evaluator = MainSearchEvaluator(THREADS, 8)
