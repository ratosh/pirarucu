...
object TexelTuningApplication {
            ...
            */
            ...
            tuningObject.registerTuningData(
                    TexelTuningData(
                            ...
                            true, intArrayOf(0, 1, 2, 3, 28, 29, 30, 31), 32
                    )
            )
    ...
    private fun optimize(tuningController: TexelTuningController) {
        val epdFileLoader = EpdFileLoader("g:\\chess\\epds\\texel-sets\\zuri_quiet_labeled.epd")
        ...
        //val evaluator = SearchErrorEvaluator(THREADS, 1)
        ...
        var bestError = ErrorUtil.calculate(epdList, constant)
        ...
        while (true) {
            while (tuningController.hasNext()) {
                if (tuningController.next()) {
                    ...
                    evaluator.evaluate(epdList)
                    val error = ErrorUtil.calculate(epdList, constant)
